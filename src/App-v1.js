...
function Header() {
  ...
  // just think that you got x form the useContext(PostContext) in the object there is property called as onClearPosts, so we are destructuring that value(basiclly we the values which we want in the component)
